            ...
            <div class="flex flex-col overflow-x-auto sm:mx-0.5 lg:mx-0.5 py-2 inline-block min-w-full sm:px-6 lg:px-8 overflow-hidden">
                <table class="min-w-full">
                    <thead class="bg-white border-b">
                        <tr>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">Nome da Sala</th>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">Bloco</th>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">Ano de Construção</th>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">Datashow</th>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">AC</th>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">Cadeiras</th>
                            <th class="text-sm font-medium text-gray-900 px-1 py-2 text-left">Computadores</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($salas as $sala): ?>
                            <tr class="bg-gray-100 border-b">
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['nome'] ?></td>
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['bloco_id'] ?></td>
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['ano_construcao'] ?></td>
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['Datashow'] ?></td>
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['AC'] ?></td>
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['Cadeiras'] ?></td>
                                <td class="text-sm text-gray-900 font-light px-1 py-2 whitespace-nowrap"><?= $sala['Computadores'] ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
