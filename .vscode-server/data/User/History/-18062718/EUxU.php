...
<body>
    ...
    <main>
        <div class="w-screen h-screen bg-gray-200 flex flex-col items-center p-20">            
            ...
            <a href="http://arteemusica.mus.br/sistema/adsgrupo06/CodeIgniter/public/index.php/salas/inserir" target="_blank" class="text-white bg-sky-900 hover:bg-sky-700 font-medium rounded-md px-4 py-6 text-center items-center">
                Inserir Sala
            </a>

                <!-- Botão para editar sala selecionada -->
            <a href="http://arteemusica.mus.br/sistema/adsgrupo06/CodeIgniter/public/index.php/salaseditarselecionada" target="_blank" class="text-white bg-sky-900 hover:bg-sky-700 font-medium rounded-md px-4 py-6 text-center items-center">
    ...
    <footer class="w-full text-center border-t border-grey p-4 pin-b bg-sky-900">
