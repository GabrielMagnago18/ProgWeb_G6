...
<body class="bg-gray-200">
    ...
    <main class="flex flex-col items-center">
        <div class="w-screen h-screen bg-gray-200 flex flex-col items-center p-20">
            ...
            <a href="http://arteemusica.mus.br/sistema/adsgrupo06/CodeIgniter/public/index.php/salas/deletar" target="_blank" class="text-white bg-sky-900 hover:bg-sky-700 font-medium rounded-md px-4 py-2 text-center items-center">
                Deletar Sala
            </a>
            </div>
    ...
    <footer class="w-full text-center pin-b bg-sky-900">
        <div class="flex flex-row justify-between p-6">
            ...
            <div class="">
        <p>&copy;2023 Helian OAB/MG sob o Nº 223.051. Todos os direitos reservados. Desenvolvido por Vinicius</p>
        </div>
    </footer>
</body>
</html>