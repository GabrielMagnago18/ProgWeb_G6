...
<body>
    <div class="w-screen h-screen bg-gradient-to-t from-gray-950 to-blue-600 flex flex-col items-center p-20 ">
        ...
        <a href="http://arteemusica.mus.br/sistema/adsgrupo06/CodeIgniter/public/index.php/salas/inserir" class="bg-slate-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
            Inserir Sala
        </a>
