...
<body>
    ...
    <main class="w-screen h-screen bg-gray-200 flex flex-col items-center p-24">
        <div class="h-64 bg-white flex flex-col items-center p-20  rounded-md">
            <h2 class="text-md p-4">Selecionar Sala para Edição</h2>
            <formmethod="get" action="salaseditarselecionada/editar">
                <div class="p-6">
                ...
                <div class="p-6">
                <p class="bg-sky-900 text-white p-2 rounded-md hover:bg-sky-7"><input type="submit" value="Editar Sala"></p>
                </div>
            </form>
        </div>
    </main>
