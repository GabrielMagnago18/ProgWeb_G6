...
<body class="bg-gray-200">
    ...
    <main class="flex flex-col items-center">
        <div class="w-screen h-screen bg-gray-200 flex flex-col items-center p-20">
            ...
            <div class="flex flex-col overflow-x-auto p-8">
                <section class="bg-white border-b flex flex-col items-center">
                    <div class="">
                        <h1 class="text-lg px-32 py-8">Listagem de Salas</h1>
                    </div>
                    ...
                    <div>
                        ...
                        <p><?= $sala['nome'] ?> - 
                            <?php if (isset($sala['sala_id'])): ?>
                                <a class="text-white bg-sky-900 hover:bg-sky-700 font-medium rounded-md px-4 py-2 text-center items-center" href="<?= base_url('salas/deletar/'.$sala['sala_id']) ?>">Deletar</a>
                            <?php else: ?>
